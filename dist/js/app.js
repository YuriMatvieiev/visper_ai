(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hardware-hero__slider")) new swiper_core_Swiper(".hardware-hero__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const langToggle = document.querySelector(".menu__lang-active");
        ...
        function handleLanguageSelection(item) {
            langToggle.textContent = item.textContent;
        ...
        function handleWindowResize() {
            ...
            } else langItems.forEach((function(item) {
                item.addEventListener("click", (function() {
                    handleLanguageSelection(item);
                }));
            }));
        ...
        if (form) form.addEventListener("submit", (function(event) {
            event.preventDefault();
            document.querySelector(".contact__form-end").style.display = "block";
            document.querySelector(".contact__form-start").style.display = "none";
        }));
    }));
    window["FLS"] = false;
    menuInit();
